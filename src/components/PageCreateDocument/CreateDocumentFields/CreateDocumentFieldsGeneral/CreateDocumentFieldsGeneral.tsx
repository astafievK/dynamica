...
import "./CreateDocumentFieldsGeneral.css";
...
import {DateRangePicker} from "../../../CustomComponents/DateRangePicker/DateRangePicker.tsx";
...
export const CreateDocumentFieldsGeneral: FC<ICreateDocumentFieldsGeneralProps> = ({ document, activeDraftId, ...rest }) => {
